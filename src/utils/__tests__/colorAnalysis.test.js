...
describe('Color Analysis', () => {
  ...
  test('should determine Winter season for cool and bright colors with dominant blue', () => {
    const winterImageData = new Uint8Array(400);
    for (let i = 0; i < winterImageData.length; i += 4) {
      winterImageData[i] = 0;       // R - pure blue
      winterImageData[i + 1] = 0;   // G - pure blue
      winterImageData[i + 2] = 255; // B - pure blue
